export default {
  ...
  vote_custodians: {
    ...
    description_side: 'Sie können bis zu 5 Verwalter wählen. Bitte wählen Sie Kandidaten, von denen Sie glauben, dass dies einen Mehrwert für eosDAC bringen.',
  ...
  votingprogress: {
    activated_at: 'eosDAC wird bei 15% aktiviert',
    loading :'lade...',
    refresh: 'aktualisiere',
    seconds : 'Sekunden',
    threshold_met : 'Registrierungs-Schwelle von 15% erreicht. eosDac ist aktiviert.',
    update_in: 'Aktualisierung in',
  },
  wallet: {
    account_name: 'Kontoname',
    action_type: 'Aktion',
