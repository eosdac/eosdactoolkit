export default {
  ...
  wallet: {
    ...
    select_token_to_send: 'Sélectionnez le jeton à envoyer',
    ...
    or_select_address_book: 'Ou sélectionnez un compte de destination dans AddressBook',
    input_a_destination_account: 'Entrer un compte de destination',
    total: 'total',
  },
  wp_member_view: {
